...
public class EnvironmentVariablesHandler extends LayoutRequestProcessor {
    ...
    protected Object getBodyVisitor(RequestHandlerContext context) {
        return new EnvironmentVariablesPageVisitor(context);
    }

    @SuppressWarnings("unused")
    private class EnvironmentVariablesPageVisitor extends AbstractVisitor {
        public EnvironmentVariablesPageVisitor(RequestHandlerContext context) {
            super(context);
        }
