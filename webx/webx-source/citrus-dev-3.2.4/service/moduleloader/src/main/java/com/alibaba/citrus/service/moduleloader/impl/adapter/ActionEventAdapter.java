...
public class ActionEventAdapter extends AbstractModuleEventAdapter {
    public ActionEventAdapter(Object moduleObject, Map<String, MethodInvoker> handlers, MethodInvoker preHandler, MethodInvoker postHandler) {
        super(moduleObject, handlers, preHandler, postHandler);
    }

    @Override
    protected String getEventName(HttpServletRequest request) {
        return ActionEventUtil.getEventName(request);
    }
}
