...
public class MailStoreNotFoundException extends MailException {
    ...
    public MailStoreNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }

    public MailStoreNotFoundException(String message) {
        super(message);
    }

    public MailStoreNotFoundException(Throwable cause) {
        super(cause);
    }
}
