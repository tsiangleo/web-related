...
public class MailTransportNotFoundException extends MailException {
    ...
    public MailTransportNotFoundException(String message, Throwable cause) {
        super(message, cause);
    }

    public MailTransportNotFoundException(String message) {
        super(message);
    }

    public MailTransportNotFoundException(Throwable cause) {
        super(cause);
    }
}
