...
public class AnyOfValidatorTests extends AbstractCompositeValidatorTests<AnyOfValidator> {
    @Override
    ...
    public void validate_allFalse() throws Exception {
        ...
        assertEquals("field1: [field1 validator 1, field1 validator 2, field1 validator 3]", field1.getMessage());
    }
}
