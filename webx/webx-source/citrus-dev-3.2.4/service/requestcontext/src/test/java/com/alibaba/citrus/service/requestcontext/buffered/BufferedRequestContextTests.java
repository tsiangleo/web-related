 ...
 * @author Michael Zhou
 */
public class BufferedRequestContextTests extends AbstractRequestContextsTests<BufferedRequestContext> {
    @BeforeClass
    public static void initFactory() {
        createBeanFactory("services-buffered.xml");
    }
    ...
    @Test
    public void commit_noContent() throws Exception {
